/*global $, chobits, Audio*/
// == BEGIN MODULE chobits._07_shell_ ====================================
chobits._07_shell_ = (function () {
  ...
  function onBombAllclearFn ( /* event_obj */ ) {
    var $all_bomb_list = $( '.chobits-_shell_bomb_' );
  ...
  function initModuleFn () {
    ...
    // Initialize styling
    chobits._06_css_._initModuleFn_();
